...
public class ChiTietSanPhamDTO {
    ...
    private Long idTrangThaiRieng; // ID của TrangThai riêng của chi tiết sản phẩm
    ...
    public ChiTietSanPhamDTO(UUID id, Integer soLuongTonKho, String moTaChiTiet, BigDecimal giaNhap, BigDecimal giaBan,
                             String maCtsp, LocalDateTime ngayNhap, Long idTrangThaiRieng, // Thêm idTrangThaiRieng
